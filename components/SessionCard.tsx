...
export function SessionCard({
  ...
  return (
    <article className={cardClass}>
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isLive ? (
              <span className="inline-flex items-center gap-1 rounded-full bg-red-500 px-2 py-0.5 text-[0.65rem] font-semibold text-white">
      ...
      {detailsOpen ? (
        <div className="mt-3 space-y-2 rounded-xl border border-white/10 bg-black/20 px-3 py-2 text-sm leading-6 text-zinc-400">
          <p>
          ...
          <p>
            <span className="font-medium text-zinc-200">Why go:</span> {session.description || "Worth a look."}
          </p>
          <p>
